...
margins age65#ward_md_sx, atmeans

*Age × Cancer site
recode catype2 (1=1) (3=2) (4=3) (5=4) (6=5), gen(catype_plot)
label define catype_plot_lbl 1 "Lung" 2 "GI" 3 "Hepato" 4 "Breast" 5 "Other"
label values catype_plot catype_plot_lbl
tab catype_plot
poisson early_718 i.age65##ib1.catype_plot i.SEX c.AGE i.exp3 i.urban i.ward_md_sx, irr vce(cluster DR_CODE)
testparm i.age65#i.catype_plot
margins age65#catype_plot

marginsplot, xdimension(catype_plot) plotdimension(age65) recast(line) recastci(rcap) legend(order(1 "<65" 2 "≥65") position(6) rows(1)) ytitle("Predicted probability of early palliative care") xtitle("Primary cancer site") title("")
***************************************************************
